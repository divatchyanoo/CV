  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        ...
        Actuellement étudiant en 2ème année
        de BTS SIO en spécialité SLAM,
        l'année prochaine je poursuivrai mes études à Epitech en Pré-MSc avec pour objectif d'intégrer un MSc-Pro cybersécurité ou intelligence artificielle.
